package me.zhangchunsheng.ucar.common.testbase;
...
import me.zhangchunsheng.ucar.common.service.impl.UcarServiceImpl;
...
public class ApiTestModule implements Module {
    ...
    public void configure(Binder binder) {
        try (InputStream inputStream = ClassLoader.getSystemResourceAsStream(TEST_CONFIG_XML)) {
            ...
            UcarService ucarService = new UcarServiceImpl();
            ucarService.setConfig(config);

            binder.bind(UcarService.class).toInstance(ucarService);
