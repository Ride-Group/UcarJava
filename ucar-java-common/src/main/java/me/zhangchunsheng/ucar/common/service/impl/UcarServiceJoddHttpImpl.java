...
/**
 * 神州专车请求实现类，jodd-http实现.
 * Created by Chunsheng Zhang on 2020/7/17.
 *
 * @author <a href="https://github.com/zhangchunsheng">Chunsheng Zhang</a>
 */
public class UcarServiceJoddHttpImpl extends BaseServiceImpl {
    @Override
    ...
    public String post(String url, Map<String, Object> params) throws UcarException {
        String requestStr = UcarServiceJoddHttpImpl.getUrlParams(params);
    ...
    private HttpRequest buildHttpRequest(String url, String requestStr) throws UcarException {
    ...
    private HttpRequest buildHttpGet(String url) throws UcarException {
        HttpRequest request = HttpRequest
                .get(url)
                .timeout(this.getConfig().getHttpTimeout())
                .connectionTimeout(this.getConfig().getHttpConnectionTimeout());
    ...
    private String getResponseString(HttpResponse response) throws UcarException {
        try {
        ...
        if (StringUtils.isBlank(responseString)) {
            throw new UcarException("响应信息为空");
        }
