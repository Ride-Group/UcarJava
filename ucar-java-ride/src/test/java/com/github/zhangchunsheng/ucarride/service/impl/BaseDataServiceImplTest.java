...
public class BaseDataServiceImplTest extends BaseTest {
    ...
    @Test
    public void testEstimatePriceWithCoupon() throws UcarException {
        Map<String, Object> params = getEstimatePriceWithCouponParams();
        EstimatePriceResult result = this.baseDataService.estimatePriceWithCoupon(params);
        assertEquals("SUCCESS", result.getStatus());
    }
}
